...
public class MainActivity extends Activity { // Consejo: utiliza como SERVICE_ID el nombre de tu paquete
...
// Arrancamos modo anunciante
    ...
    public void doRemoteAction() {
        wifiutils.connectToAP("Home", "");
        wifiutils.listNetworks();
        wifiutils.getConnectionInfo();
    }

    private void startAdvertising() {
        Nearby.getConnectionsClient(this).startAdvertising("Nearby LED", SERVICE_ID, mConnectionLifecycleCallback, new AdvertisingOptions(Strategy.P2P_STAR)).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    private final PayloadCallback mPayloadCallback = new PayloadCallback() {
        ...
        public void onPayloadTransferUpdate(String endpointId, PayloadTransferUpdate update) {
            // Actualizaciones sobre el proceso de transferenci
        }
    };
